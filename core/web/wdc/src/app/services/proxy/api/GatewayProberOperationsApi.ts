...
@Injectable()
export class GatewayProberOperationsApi
{
    ...
    */
    ...
    {
        return this.basePath + '/gateway-prober-operations/item/${id}/log/filter'
    ...
    */
    ...
    {
        return this.basePath + '/gateway-prober-operations/item/${id}'
                   .replace('${' + 'id' + '}', encodeURIComponent(String(id)));
    }
     ...
     * @param id
     */
    public async get(id: string): Promise<models.GatewayProberOperation>
    {
        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined)
        {
    ...
    */
    ...
    {
        return this.basePath + '/gateway-prober-operations/all/${id}'
                   .replace('${' + 'id' + '}', encodeURIComponent(String(id)));
    }
    ...
    */
    ...
    {
        return this.basePath + '/gateway-prober-operations/batch';
    }
     ...
     * @param body
     */
    public async getBatch(body?: Array<string>): Promise<Array<models.GatewayProberOperation>>
    {
        ...
        let __res = <Array<models.GatewayProberOperation>> await this.client.callWithOptions(__path, __requestOptions);
        if (__res)
        {
            for (let val of __res)
            {
                models.GatewayProberOperation.fixupPrototype(val);
            }
        }
    ...
    */
    ...
    {
        return this.basePath + '/gateway-prober-operations/item/${id}/log'
                   .replace('${' + 'id' + '}', encodeURIComponent(String(id)));
    }
