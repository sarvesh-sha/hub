...
export class RolesApi
{
    ...
    */
    ...
    {
        return this.basePath + '/roles/item/${id}'
     ...
     * @param id
     */
    public async get(id: string): Promise<models.Role>
    {
        ...
        let __res = <models.Role> await this.client.callWithOptions(__path, __requestOptions);
        if (__res)
        {
            models.Role.fixupPrototype(__res);
        }
    ...
    */
    ...
    {
        return this.basePath + '/roles/all';
    }
    ...
    */
    ...
    {
        return this.basePath + '/roles/batch';
    }
     ...
     * @param body
     */
    public async getBatch(body?: Array<string>): Promise<Array<models.Role>>
    {
        ...
        let __res = <Array<models.Role>> await this.client.callWithOptions(__path, __requestOptions);
        if (__res)
        {
            for (let val of __res)
            {
