...
@Injectable()
export class MetricsDefinitionsApi
{
    ...
    */
    ...
    {
        return this.basePath + '/metrics-definitions/create';
    }
     ...
     * @param body
     */
    public async create(body?: models.MetricsDefinition): Promise<models.MetricsDefinition>
    {
    ...
    */
    ...
    {
        return this.basePath + '/metrics-definitions/item/${id}'
     ...
     * @param id
     */
    public async get(id: string): Promise<models.MetricsDefinition>
    {
    ...
    */
    ...
    {
        return this.basePath + '/metrics-definitions/batch';
    }
     ...
     * @param body
     */
    public async getBatch(body?: Array<string>): Promise<Array<models.MetricsDefinition>>
    {
        ...
        let __res = <Array<models.MetricsDefinition>> await this.client.callWithOptions(__path, __requestOptions);
        if (__res)
        {
            for (let val of __res)
            {
                models.MetricsDefinition.fixupPrototype(val);
            }
        }
    ...
    */
    ...
    {
        return this.basePath + '/metrics-definitions/filter';
    }
     ...
     * @param body
     */
    public async getFiltered(body?: models.MetricsDefinitionFilterRequest): Promise<Array<models.RecordIdentity>>
    {
    ...
    */
    ...
    {
        return this.basePath + '/metrics-definitions/parse-import';
    }
     ...
     * @param body
     */
    public async parseImport(body?: models.RawImport): Promise<models.MetricsDefinition>
    {
    ...
    */
     ...
     * @param body
     */
    public async update(id: string, dryRun?: boolean, body?: models.MetricsDefinition): Promise<models.ValidationResults>
    {
        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined)
        {
