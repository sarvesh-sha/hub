...
export class UserGroupsApi
{
    ...
    *
    */
    public batchExport__generateUrl(): string
    {
        return this.basePath + '/user-groups/batch-export';
    }
     ...
     *
     */
    public async batchExport(): Promise<models.UserGroupImportExport>
    {

        const __path = this.batchExport__generateUrl();
        ...
        let __res = <models.UserGroupImportExport> await this.client.callWithOptions(__path, __requestOptions);
        if (__res)
        {
            models.UserGroupImportExport.fixupPrototype(__res);
        }
    ...
    *
    */
    public batchImport__generateUrl(): string
    {
        return this.basePath + '/user-groups/batch-import';
    }
     ...
     * @param body
     */
    public async batchImport(body?: models.UserGroupImportExport): Promise<models.UserGroupImportExport>
    {

        const __path = this.batchImport__generateUrl();
    ...
    */
    ...
    {
        return this.basePath + '/user-groups/create';
    }
     ...
     * @param body
     */
    public async create(body?: models.UserGroupCreationRequest): Promise<models.UserGroup>
    {
        ...
        let __res = <models.UserGroup> await this.client.callWithOptions(__path, __requestOptions);
        if (__res)
        {
            models.UserGroup.fixupPrototype(__res);
        }
    ...
    */
    ...
    {
        return this.basePath + '/user-groups/item/${id}'
     ...
     * @param id
     */
    public async get(id: string): Promise<models.UserGroup>
    {
    ...
    */
    ...
    {
        return this.basePath + '/user-groups/all';
    }
    ...
    */
    ...
    {
        return this.basePath + '/user-groups/batch';
    }
     ...
     * @param body
     */
    public async getBatch(body?: Array<string>): Promise<Array<models.UserGroup>>
    {
        ...
        let __res = <Array<models.UserGroup>> await this.client.callWithOptions(__path, __requestOptions);
        if (__res)
        {
            for (let val of __res)
            {
    ...
    */
     ...
     * @param body
     */
    public async update(id: string, dryRun?: boolean, body?: models.UserGroup): Promise<models.ValidationResults>
    {
        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined)
        {
