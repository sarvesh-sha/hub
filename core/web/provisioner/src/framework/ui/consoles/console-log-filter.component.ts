...
export class ConsoleLogFilterComponent extends BaseComponent
{
    ...
    constructor(inj: Injector)
    {
        ...
        this.overlayConfig.onTopDraggable();
        this.overlayConfig.width     = 325;
        this.overlayConfig.maxHeight = "90vh";

        this.subscribeToObservable(this.filterUpdated.pipe(debounceTime(250)), this.onFilterUpdate.bind(this));
