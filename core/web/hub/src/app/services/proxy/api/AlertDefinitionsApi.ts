...
@Injectable()
export class AlertDefinitionsApi
{
    ...
    */
    ...
    {
        return this.basePath + '/alert-definitions/create';
    }
     ...
     * @param body
     */
    public async create(body?: models.AlertDefinition): Promise<models.AlertDefinition>
    {
        ...
        let __res = <models.AlertDefinition> await this.client.callWithOptions(__path, __requestOptions);
        if (__res)
        {
            models.AlertDefinition.fixupPrototype(__res);
        }
    ...
    */
    ...
    {
        return this.basePath + '/alert-definitions/item/${id}/log'
    ...
    */
    ...
    {
        return this.basePath + '/alert-definitions/item/${id}/log/filter'
                   .replace('${' + 'id' + '}', encodeURIComponent(String(id)));
    }
    ...
    */
    ...
    {
        return this.basePath + '/alert-definitions/item/${id}'
                   .replace('${' + 'id' + '}', encodeURIComponent(String(id)));
    }
     ...
     * @param id
     */
    public async get(id: string): Promise<models.AlertDefinition>
    {
        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined)
        {
    ...
    */
    ...
    {
        return this.basePath + '/alert-definitions/batch';
    }
     ...
     * @param body
     */
    public async getBatch(body?: Array<string>): Promise<Array<models.AlertDefinition>>
    {
        ...
        let __res = <Array<models.AlertDefinition>> await this.client.callWithOptions(__path, __requestOptions);
        if (__res)
        {
            for (let val of __res)
            {
                models.AlertDefinition.fixupPrototype(val);
            }
        }
    ...
    */
    ...
    {
        return this.basePath + '/alert-definitions/filter';
    }
     ...
     * @param body
     */
    public async getFiltered(body?: models.AlertDefinitionFilterRequest): Promise<Array<models.RecordIdentity>>
    {
    ...
    */
    ...
    {
        return this.basePath + '/alert-definitions/parse-import';
    }
     ...
     * @param body
     */
    public async parseImport(body?: models.RawImport): Promise<models.AlertDefinition>
    {
    ...
    */
     ...
     * @param body
     */
    public async update(id: string, dryRun?: boolean, body?: models.AlertDefinition): Promise<models.ValidationResults>
    {
        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined)
        {
