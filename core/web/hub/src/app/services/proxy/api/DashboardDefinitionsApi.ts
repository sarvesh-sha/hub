...
@Injectable()
export class DashboardDefinitionsApi
{
    ...
    */
    ...
    {
        return this.basePath + '/dashboard-definitions/create';
    }
     ...
     * @param body
     */
    public async create(body?: models.DashboardDefinition): Promise<models.DashboardDefinition>
    {
        ...
        let __res = <models.DashboardDefinition> await this.client.callWithOptions(__path, __requestOptions);
        if (__res)
        {
            models.DashboardDefinition.fixupPrototype(__res);
        }
    ...
    */
    ...
    {
        return this.basePath + '/dashboard-definitions/item/${id}'
     ...
     * @param id
     */
    public async get(id: string): Promise<models.DashboardDefinition>
    {
    ...
    */
    ...
    {
        return this.basePath + '/dashboard-definitions/all';
    }
    ...
    */
    ...
    {
        return this.basePath + '/dashboard-definitions/batch';
    }
     ...
     * @param body
     */
    public async getBatch(body?: Array<string>): Promise<Array<models.DashboardDefinition>>
    {
        ...
        let __res = <Array<models.DashboardDefinition>> await this.client.callWithOptions(__path, __requestOptions);
        if (__res)
        {
            for (let val of __res)
            {
                models.DashboardDefinition.fixupPrototype(val);
            }
        }
    ...
    * @param id
    */
    public getHistory__generateUrl(id: string): string
    {
        return this.basePath + '/dashboard-definitions/item/${id}/history'
                   .replace('${' + 'id' + '}', encodeURIComponent(String(id)));
    }
     ...
     * @param id
     */
    public async getHistory(id: string): Promise<Array<models.DashboardDefinitionVersion>>
    {
        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined)
        {
        ...
        const __path = this.getHistory__generateUrl(id);
    ...
    *
    */
    public push__generateUrl(): string
    {
        return this.basePath + '/dashboard-definitions/admin/push';
    }
     ...
     * @param body
     */
    public async push(dryRun?: boolean, create?: boolean, body?: models.DashboardConfiguration): Promise<models.ValidationResults>
    {

        const __path = this.push__generateUrl();
        ...
        if (create !== undefined)
        {
            __requestOptions.setQueryParam('create', <any>create);
        }
    ...
    */
     ...
     * @param body
     */
    public async update(id: string, dryRun?: boolean, body?: models.DashboardDefinition): Promise<models.ValidationResults>
    {
        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined)
        {
