...
@Component({
               selector   : "o3-datagram-sessions-page",
               templateUrl: "./datagram-sessions-page.component.html"
           })
export class DatagramSessionsPageComponent extends SharedSvc.BaseApplicationComponent
{
...
class SessionsDetails implements IDatatableDataProvider<SessionDetails, SessionDetails, SessionDetails>
{
    ...
    constructor(private component: DatagramSessionsPageComponent,
    ...
    public async itemClicked(columnId: string,
                             item: SessionDetails)
    {
        this.component.app.ui.navigation.go("/gateways/gateway", [item.model.contextSysId]);
    }
