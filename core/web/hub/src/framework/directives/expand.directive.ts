...
export class ExpandDirective extends BaseComponent implements AfterViewChecked
{
    ...
    private m_containerElemSelector: string = ".page-container"; // goes up DOM til it finds container that matches selector
    ...
    async expand()
    {
        ...
        if (!this.m_expanding)
        {
            ...
            if (!this.m_container) return; // Element destroyed.
