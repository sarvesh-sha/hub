                                                                                                                         ...
                                                                                                                         OnDestroy
{
    ...
    protected abstract async loadItems(): Promise<void>;

    protected abstract async onEmptyFilterResults(): Promise<void>;
...
export abstract class BaseDialogComponentSingleSelect<T extends BaseDialogComponentSingleSelect<T, V>, V extends BaseDialogSelection> extends BaseDialogComponent<T, V>
{
                                                                                                                     ...
                                                                                                                     height?: string): Promise<V>
    {
        ...
        if (closableViaBackdrop !== undefined)
        {
            overlayConfig.closableViaBackdrop = closableViaBackdrop;
        }
