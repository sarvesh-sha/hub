...
export class LoggersComponent extends SharedSvc.BaseApplicationComponent
{
    ...
    @Input() set loggers(value: Array<Models.LoggerConfiguration>)
    {
        ...
        this.m_loggers.sort((a,
                             b) =>
                            {
                                ...
                                return UtilsService.compareStrings(fullNameA, fullNameB, true);
                            });
    ...
    loggerLookup: Lookup<Models.LoggerConfiguration>;

    loggersMap: Lookup<Lookup<number>>;

    private m_loggersUpdated: Lookup<boolean> = null;
