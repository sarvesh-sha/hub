...
@Injectable()
export class RepositoryBranchesApi
{
    ...
    */
    ...
    {
        return this.basePath + '/repository-branches/item/${id}'
     ...
     * @param id
     */
    public async get(id: string): Promise<models.RepositoryBranch>
    {
        ...
        let __res = <models.RepositoryBranch> await this.client.callWithOptions(__path, __requestOptions);
        if (__res)
        {
            models.RepositoryBranch.fixupPrototype(__res);
        }
    ...
    */
    ...
    {
        return this.basePath + '/repository-branches/all/${id}'
                   .replace('${' + 'id' + '}', encodeURIComponent(String(id)));
    }
    ...
    */
    ...
    {
        return this.basePath + '/repository-branches/batch';
    }
     ...
     * @param body
     */
    public async getBatch(body?: Array<string>): Promise<Array<models.RepositoryBranch>>
    {
        ...
        let __res = <Array<models.RepositoryBranch>> await this.client.callWithOptions(__path, __requestOptions);
        if (__res)
        {
            for (let val of __res)
            {
                models.RepositoryBranch.fixupPrototype(val);
            }
        }
