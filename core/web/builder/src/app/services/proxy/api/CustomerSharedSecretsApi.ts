...
@Injectable()
export class CustomerSharedSecretsApi
{
    ...
    */
    ...
    {
        return this.basePath + '/customer-shared-secrets/create/${customerId}'
     ...
     * @param body
     */
    public async create(customerId: string, body?: models.CustomerSharedSecret): Promise<models.CustomerSharedSecret>
    {
        ...
        let __res = <models.CustomerSharedSecret> await this.client.callWithOptions(__path, __requestOptions);
        if (__res)
        {
            models.CustomerSharedSecret.fixupPrototype(__res);
        }
    ...
    */
    ...
    {
        return this.basePath + '/customer-shared-secrets/item/${id}'
     ...
     * @param id
     */
    public async get(id: string): Promise<models.CustomerSharedSecret>
    {
    ...
    */
    ...
    {
        return this.basePath + '/customer-shared-secrets/all/${customerId}'
                   .replace('${' + 'customerId' + '}', encodeURIComponent(String(customerId)));
    }
    ...
    */
    ...
    {
        return this.basePath + '/customer-shared-secrets/batch';
    }
     ...
     * @param body
     */
    public async getBatch(body?: Array<string>): Promise<Array<models.CustomerSharedSecret>>
    {
        ...
        let __res = <Array<models.CustomerSharedSecret>> await this.client.callWithOptions(__path, __requestOptions);
        if (__res)
        {
            for (let val of __res)
            {
                models.CustomerSharedSecret.fixupPrototype(val);
            }
        }
    ...
    */
     ...
     * @param body
     */
    public async update(id: string, dryRun?: boolean, body?: models.CustomerSharedSecret): Promise<models.ValidationResults>
    {
        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined)
        {
