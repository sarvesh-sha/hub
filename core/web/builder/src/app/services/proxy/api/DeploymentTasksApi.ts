...
@Injectable()
export class DeploymentTasksApi
{
    ...
    */
    ...
    {
        return this.basePath + '/deployment-tasks/item/${id}/log/filter'
    ...
    */
    ...
    {
        return this.basePath + '/deployment-tasks/item/${id}'
                   .replace('${' + 'id' + '}', encodeURIComponent(String(id)));
    }
     ...
     * @param id
     */
    public async get(id: string): Promise<models.DeploymentTask>
    {
        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined)
        {
        ...
        let __res = <models.DeploymentTask> await this.client.callWithOptions(__path, __requestOptions);
        if (__res)
        {
            models.DeploymentTask.fixupPrototype(__res);
        }
    ...
    */
    ...
    {
        return this.basePath + '/deployment-tasks/all/${id}'
                   .replace('${' + 'id' + '}', encodeURIComponent(String(id)));
    }
    ...
    */
    ...
    {
        return this.basePath + '/deployment-tasks/batch';
    }
     ...
     * @param body
     */
    public async getBatch(body?: Array<string>): Promise<Array<models.DeploymentTask>>
    {
        ...
        let __res = <Array<models.DeploymentTask>> await this.client.callWithOptions(__path, __requestOptions);
        if (__res)
        {
            for (let val of __res)
            {
    ...
    */
    ...
    {
        return this.basePath + '/deployment-tasks/item/${id}/log'
                   .replace('${' + 'id' + '}', encodeURIComponent(String(id)));
    }
    ...
    */
    ...
    {
        return this.basePath + '/deployment-tasks/item/${id}/restart'
                   .replace('${' + 'id' + '}', encodeURIComponent(String(id)));
    }
     ...
     * @param dryRun
     */
    public async restart(id: string, dryRun?: boolean): Promise<models.ValidationResults>
    {
        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined)
        {
    ...
    */
    ...
    {
        return this.basePath + '/deployment-tasks/item/${id}/terminate'
                   .replace('${' + 'id' + '}', encodeURIComponent(String(id)));
    }
