...
@Injectable()
export class CustomerSharedUsersApi
{
    ...
    */
    ...
    {
        return this.basePath + '/customer-shared-users/create/${customerId}'
     ...
     * @param body
     */
    public async create(customerId: string, body?: models.UserCreationRequest): Promise<models.CustomerSharedUser>
    {
        ...
        let __res = <models.CustomerSharedUser> await this.client.callWithOptions(__path, __requestOptions);
        if (__res)
        {
            models.CustomerSharedUser.fixupPrototype(__res);
        }
    ...
    */
    ...
    {
        return this.basePath + '/customer-shared-users/item/${id}'
     ...
     * @param id
     */
    public async get(id: string): Promise<models.CustomerSharedUser>
    {
    ...
    */
    ...
    {
        return this.basePath + '/customer-shared-users/all/${customerId}'
                   .replace('${' + 'customerId' + '}', encodeURIComponent(String(customerId)));
    }
    ...
    */
    ...
    {
        return this.basePath + '/customer-shared-users/batch';
    }
     ...
     * @param body
     */
    public async getBatch(body?: Array<string>): Promise<Array<models.CustomerSharedUser>>
    {
        ...
        let __res = <Array<models.CustomerSharedUser>> await this.client.callWithOptions(__path, __requestOptions);
        if (__res)
        {
            for (let val of __res)
            {
                models.CustomerSharedUser.fixupPrototype(val);
            }
        }
    ...
    */
     ...
     * @param body
     */
    public async update(id: string, dryRun?: boolean, body?: models.CustomerSharedUser): Promise<models.ValidationResults>
    {
        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined)
        {
