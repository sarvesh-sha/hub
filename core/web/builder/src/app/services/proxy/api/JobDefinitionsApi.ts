...
@Injectable()
export class JobDefinitionsApi
{
    ...
    */
    ...
    {
        return this.basePath + '/job-definitions/create';
    }
     ...
     * @param body
     */
    public async create(body?: models.JobDefinition): Promise<models.JobDefinition>
    {
        ...
        let __res = <models.JobDefinition> await this.client.callWithOptions(__path, __requestOptions);
        if (__res)
        {
            models.JobDefinition.fixupPrototype(__res);
        }
    ...
    */
    ...
    {
        return this.basePath + '/job-definitions/item/${id}'
     ...
     * @param id
     */
    public async get(id: string): Promise<models.JobDefinition>
    {
    ...
    */
    ...
    {
        return this.basePath + '/job-definitions/all';
    }
    ...
    */
    ...
    {
        return this.basePath + '/job-definitions/batch';
    }
     ...
     * @param body
     */
    public async getBatch(body?: Array<string>): Promise<Array<models.JobDefinition>>
    {
        ...
        let __res = <Array<models.JobDefinition>> await this.client.callWithOptions(__path, __requestOptions);
        if (__res)
        {
            for (let val of __res)
            {
                models.JobDefinition.fixupPrototype(val);
            }
        }
    ...
    * @param id
    */
    public trigger__generateUrl(id: string): string
    {
        return this.basePath + '/job-definitions/trigger/${id}'
                   .replace('${' + 'id' + '}', encodeURIComponent(String(id)));
    }
     ...
     * @param commit
     */
    public async trigger(id: string, branch?: string, commit?: string): Promise<models.Job>
    {
        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined)
        {
            throw new Error('Required parameter id was null or undefined when calling trigger.');
        }

        const __path = this.trigger__generateUrl(id);

        let __requestOptions = new ApiRequest();

        if (branch !== undefined)
        {
            __requestOptions.setQueryParam('branch', <any>branch);
        }

        if (commit !== undefined)
        {
            __requestOptions.setQueryParam('commit', <any>commit);
        }
    ...
    */
     ...
     * @param body
     */
    public async update(id: string, dryRun?: boolean, body?: models.JobDefinition): Promise<models.ValidationResults>
    {
        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined)
        {
