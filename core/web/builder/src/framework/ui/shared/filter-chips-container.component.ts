...
export class FilterChipsContainerComponent extends BaseComponent
{
    ...
    @Output() editFilterRequested = new EventEmitter<void>();
    ...
    public ngAfterViewInit(): void
    {
        ...
        setTimeout(() => this.updateMaxNumChips());
    }
...
{
    protected idToLabel: Lookup<string> = {};
    ...
    get label(): string
    {
        ...
        if (this.isBoolean && filterNames.length == 1)
        {
