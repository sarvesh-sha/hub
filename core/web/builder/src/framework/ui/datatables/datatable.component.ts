...
export class DatatableColumnDirective
{
    ...
    @Input() stylesFn: (value: any) => Lookup<string> = () => null;
...
export class DatatableComponent<K, E, T> extends BaseComponent
{
    ...
    getCustomStyles(styles: Lookup<string>): Lookup<string>
    {
        styles = {...styles};

        delete styles["flex-basis"];
        delete styles["flex-grow"];
        delete styles["flex-shrink"];
