...
public final class UnconfirmedCOVNotificationMultiple extends UnconfirmedServiceRequest
{
    ...
    public static final class Notifications extends Sequence
    {
        ...
        @SerializationTag(number = 1)
        public List<Values> list_of_values;
    }
    ...
    public List<Values> list_of_cov_notifications;
}
