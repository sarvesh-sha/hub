...
public class ReadDiscreteInputs extends ApplicationPDU
{
    public static class Response extends ApplicationPDU.Response
    {
        ...
        protected void validateAfterDecoding()
        {
            if (results == null)
            {
                throw ModbusDecodingException.newException("Invalid ReadDiscreteInputs.Response");
            }

            if (count != results.length)
            {
                throw ModbusDecodingException.newException("Mot enough values for ReadDiscreteInputs.Response: %d != %d", count, results.length);
            }
        }
    ...
    protected void validateAfterDecoding()
    {
        ...
        {
            throw ModbusDecodingException.newException("ReadDiscreteInputs ReadCoils");
        }
    }
}
