...
public class ExpandableArrayOfInts implements AutoCloseable
{
    ...
    private final static ObjectRecycler<int[]> s_segmentRecycler;
    ...
    static
    {
        ...
        s_segmentRecycler = ObjectRecycler.build((int) (segmentCacheSize / (c_segmentSize * c_elementSize)), 32, int[].class, () -> new int[c_segmentSize], null);
    }

    static class State
    {
        int[][] segmentedArrays = new int[10][];
    ...
    public class Batch implements AutoCloseable
    {
        ...
        public void getRange(int arrayOffset,
                             ...
                             int length)
        {
            ExpandableArrayOfInts.this.getRange(arrayOffset, tempBuffer, batchOffset, length);
        }
        ...
        public void setRange(int arrayOffset,
                             ...
                             int length)
        {
            ExpandableArrayOfInts.this.setRange(arrayOffset, tempBuffer, batchOffset, length);
        }

        public void addRange(int batchOffset,
                             int length)
        {
            ExpandableArrayOfInts.this.addRange(tempBuffer, batchOffset, length);
        }
    }
    ...
    private ExpandableArrayOfInts(State state)
    {
        m_state = state;
    }

    public static ExpandableArrayOfInts create()
    {
        return new ExpandableArrayOfInts(s_stateRecycler.acquireRaw());
    }

    public static ExpandableArrayOfInts create(int[] array)
    {
                      ...
                      int value)
    {
        ...
        while (true)
        {
            ...
            int[] segmentedArray = m_state.segmentedArrays[chunkIndex];

            // Save the last value, it will be overwritten.
            int lastValue = segmentedArray[chunkEndOffset];
                      ...
                      boolean rotate)
    {
        ...
        while (true)
        {
            ...
            int firstValue = segmentedArray[chunkStartOffset];
    ...
    public ExpandableArrayOfInts copy()
    {
        var copy = ExpandableArrayOfInts.create();
    ...
    public int[] toArray()
    {
        var result = new int[m_size];
        toArray(result);
        return result;
    }

    public void toArray(int[] buf)
    {
                        ...
                        int length)
    {
        ...
        int[][] segmentedArrays = m_state.segmentedArrays;
