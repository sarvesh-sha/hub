...
public class ExpandableArrayOfFloats implements AutoCloseable
{
    private static final int c_elementSizeLog2   = 2;
    ...
    private final static ObjectRecycler<float[]> s_segmentRecycler;
    ...
    static
    {
        ...
        s_segmentRecycler = ObjectRecycler.build((int) (segmentCacheSize / (c_segmentSize * c_elementSize)), 32, float[].class, () -> new float[c_segmentSize], null);
    }

    static class State
    {
        float[][] segmentedArrays = new float[10][];
    ...
    public class Batch implements AutoCloseable
    {
        ...
        public void getRange(int arrayOffset,
                             ...
                             int length)
        {
            ExpandableArrayOfFloats.this.getRange(arrayOffset, tempBuffer, batchOffset, length);
        }
        ...
        public void setRange(int arrayOffset,
                             ...
                             int length)
        {
            ExpandableArrayOfFloats.this.setRange(arrayOffset, tempBuffer, batchOffset, length);
        }

        public void addRange(int batchOffset,
                             int length)
        {
            ExpandableArrayOfFloats.this.addRange(tempBuffer, batchOffset, length);
        }
    }
    ...
    private ExpandableArrayOfFloats(State state)
    {
        m_state = state;
    }

    public static ExpandableArrayOfFloats create()
    {
        return new ExpandableArrayOfFloats(s_stateRecycler.acquireRaw());
    }

    public static ExpandableArrayOfFloats create(float[] array)
    {
                        ...
                        float value)
    {
        ...
        while (true)
        {
            ...
            float[] segmentedArray = m_state.segmentedArrays[chunkIndex];

            // Save the last value, it will be overwritten.
            float lastValue = segmentedArray[chunkEndOffset];
                        ...
                        boolean rotate)
    {
        ...
        float value = rotate ? get(pos, 0) : 0;
        ...
        while (true)
        {
            ...
            float firstValue = segmentedArray[chunkStartOffset];
    ...
    public ExpandableArrayOfFloats copy()
    {
        var copy = ExpandableArrayOfFloats.create();
    ...
    {
        var result = new float[m_size];
        toArray(result);
        return result;
    }

    public void toArray(float[] buf)
    {
                        ...
                        int length)
    {
        ...
        float[][] segmentedArrays = m_state.segmentedArrays;
