...
public class ExpandableArrayOfDoubles implements AutoCloseable
{
    ...
    private final static ObjectRecycler<double[]> s_segmentRecycler;
    ...
    static
    {
        ...
        s_segmentRecycler = ObjectRecycler.build((int) (segmentCacheSize / (c_segmentSize * c_elementSize)), 64, double[].class, () -> new double[c_segmentSize], null);
    }

    static class State
    {
        double[][] segmentedArrays = new double[10][];
    ...
    {
        public final double[] tempBuffer;
        ...
        public void getRange(int arrayOffset,
                             ...
                             int length)
        {
            ExpandableArrayOfDoubles.this.getRange(arrayOffset, tempBuffer, batchOffset, length);
        }
        ...
        public void setRange(int arrayOffset,
                             ...
                             int length)
        {
            ExpandableArrayOfDoubles.this.setRange(arrayOffset, tempBuffer, batchOffset, length);
        }

        public void addRange(int batchOffset,
                             int length)
        {
            ExpandableArrayOfDoubles.this.addRange(tempBuffer, batchOffset, length);
        }
    }
    ...
    private ExpandableArrayOfDoubles(State state)
    {
        m_state = state;
    }

    public static ExpandableArrayOfDoubles create()
    {
        return new ExpandableArrayOfDoubles(s_stateRecycler.acquireRaw());
    }

    public static ExpandableArrayOfDoubles create(double[] array)
    {
                         ...
                         double value)
    {
        ...
        while (true)
        {
            ...
            double[] segmentedArray = m_state.segmentedArrays[chunkIndex];

            // Save the last value, it will be overwritten.
            double lastValue = segmentedArray[chunkEndOffset];
                         ...
                         boolean rotate)
    {
        ...
        double value = rotate ? get(pos, 0) : 0;
        ...
        while (true)
        {
            ...
            double firstValue = segmentedArray[chunkStartOffset];
    ...
    public ExpandableArrayOfDoubles copy()
    {
        var copy = ExpandableArrayOfDoubles.create();
    ...
    {
        var result = new double[m_size];
        toArray(result);
        return result;
    }

    public void toArray(double[] buf)
    {
                        ...
                        int length)
    {
        ...
        double[][] segmentedArrays = m_state.segmentedArrays;
