...
@JsonTypeName("EngineOperatorUnaryIsValidNumber")
public class EngineOperatorUnaryIsValidNumber extends EngineOperatorUnaryFromCore<EngineValuePrimitiveBoolean, EngineValuePrimitiveNumber>
{
    public EngineOperatorUnaryIsValidNumber()
    {
