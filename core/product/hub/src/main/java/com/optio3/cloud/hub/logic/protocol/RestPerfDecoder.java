...
public class RestPerfDecoder implements IProtocolDecoder
{
    @Override
    public GatewayDiscoveryEntitySelector getRootSelector()
    {
        return GatewayDiscoveryEntitySelector.Host;
    }
    ...
    @Override
    public RestDescriptor decodeDeviceContext(GatewayDiscoveryEntity en_root,
    ...
    {
        return new RestPerfHandlerForBatchIngestion(cfg, logger, forAsset);
    }
}
