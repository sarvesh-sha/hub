...
public class NetworkPerfDecoder implements IProtocolDecoder
{
    @Override
    ...
    @Override
    public NetworkDescriptor decodeDeviceContext(GatewayDiscoveryEntity en_root,
    ...
    {
        return new NetworkPerfHandlerForBatchIngestion(cfg, logger, forAsset);
    }
}
