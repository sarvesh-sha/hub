...
@JsonTypeName("NormalizationEngineOperatorUnaryGetPointClassName")
public class NormalizationEngineOperatorUnaryGetPointClassName extends EngineOperatorUnaryFromNormalization<EngineValuePrimitiveString, EngineValuePrimitiveString>
{
    public NormalizationEngineOperatorUnaryGetPointClassName()
    {
                                                       ...
                                                       EngineValuePrimitiveString value)
    {
        ...
        return pointClass != null ? EngineValuePrimitiveString.create(pointClass.pointClassName) : null;
    }
}
