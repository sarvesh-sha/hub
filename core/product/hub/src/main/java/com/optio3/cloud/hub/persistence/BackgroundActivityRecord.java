...
import com.optio3.cloud.hub.model.BackgroundActivity;
...
public class BackgroundActivityRecord extends RecordForBackgroundActivity<BackgroundActivityRecord, BackgroundActivityChunkRecord, HostAssetRecord> implements ModelMapperTarget<BackgroundActivity, BackgroundActivityRecord_>
{
    /**
     * List of all the tasks this task is waiting for.
     */
    ...
    /**
     * The tasks that was waiting on this task.
     */
    ...
    @Optio3Cascade(mode = Optio3Cascade.Flavor.DELETE, getter = "getHostAffinity")
    ...
    private HostAssetRecord hostAffinity;
    ...
    @Override
    public HostAssetRecord getWorker()
    {
        return getHostAffinity();
    }

    @Override
    public void setWorker(HostAssetRecord worker)
    {
        setHostAffinity(worker);
    }

    public HostAssetRecord getHostAffinity()
    {
        return hostAffinity;
    }

    public void setHostAffinity(HostAssetRecord hostAffinity)
    {
        // Lazy fields have to be loaded before setting them again, or Hibernate will miss the update if you try to null the field.
    ...
    public static BackgroundActivityRecord schedule(SessionHolder sessionHolder,
                                                    BackgroundActivityHandler<BackgroundActivityRecord, BackgroundActivityChunkRecord, HostAssetRecord> handler,
    ...
    {
        return RecordForBackgroundActivity.findNextActivation(helper, null);
    }

    public static <H extends BackgroundActivityHandler<BackgroundActivityRecord, BackgroundActivityChunkRecord, HostAssetRecord>> TypedRecordIdentityList<BackgroundActivityRecord> findHandlers(SessionHolder sessionHolder,
                                                                                                                                                                                                 boolean onlyDone,
                                                                                                                                                                                                 boolean onlyNotDone,
                                                                                                                                                                                                 Class<H> clzHandler,
