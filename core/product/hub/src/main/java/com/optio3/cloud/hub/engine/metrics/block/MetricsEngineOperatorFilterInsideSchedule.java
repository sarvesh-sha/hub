...
@JsonTypeName("MetricsEngineOperatorFilterInsideSchedule")
public class MetricsEngineOperatorFilterInsideSchedule extends MetricsEngineOperatorBaseWithSchedule
{
    @Override
    ...
    {
        return computeResult(ctx, stack, series, schedule, true);
    }
}
