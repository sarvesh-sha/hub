...
@JsonTypeName("EngineOperatorUnaryIsEmpty")
public class EngineOperatorUnaryIsEmpty extends EngineOperatorUnaryFromCore<EngineValuePrimitiveBoolean, EngineValue>
{
    public EngineOperatorUnaryIsEmpty()
    {
