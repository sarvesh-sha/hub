...
@JsonSubTypes({ @JsonSubTypes.Type(value = MetricsDefinitionDetailsForUserProgram.class) })
public abstract class MetricsDefinitionDetails extends EngineDefinitionDetails
{
