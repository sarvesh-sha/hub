...
@JsonTypeName("EngineExpressionFormatText")
public class EngineExpressionFormatText extends EngineExpressionFromCore<EngineValuePrimitiveString>
{
    public EngineExpression<EngineValuePrimitive> format;
    public List<EngineExpression<?>>              arguments;

    public EngineExpressionFormatText()
    {
        ...
        switch (scratchPad.stateMachine)
        {
            ...
            default:
            {
                ...
                else
                {
                    ...
                    String text       = ctx.format(stack, formatText, stack.childResults);

                    ctx.popBlock(EngineValuePrimitiveString.create(text));
                }
            }
        }
    }
