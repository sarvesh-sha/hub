...
@JsonTypeName("MetricsEngineOperatorThresholdPartialDuration")
public class MetricsEngineOperatorThresholdPartialDuration extends EngineOperatorBinaryFromMetrics<MetricsEngineValueSeries, MetricsEngineValueSeries, MetricsEngineValueScalar>
{
    public CommonEngineCompareOperation operation;

    public MetricsEngineOperatorThresholdPartialDuration()
    {
