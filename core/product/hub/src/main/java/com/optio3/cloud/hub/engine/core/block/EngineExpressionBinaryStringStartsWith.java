...
@JsonTypeName("EngineExpressionBinaryStringStartsWith")
public class EngineExpressionBinaryStringStartsWith extends EngineOperatorBinaryFromCore<EngineValuePrimitiveBoolean, EngineValuePrimitiveString, EngineValuePrimitiveString>
{
    public EngineExpressionBinaryStringStartsWith()
    {
                                                        ...
                                                        EngineValuePrimitiveString v2)
    {
        ...
        return EngineValuePrimitiveBoolean.create(t1 != null && t2 != null && t1.startsWith(t2));
    }
}
