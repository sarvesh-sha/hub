...
public class NetworkPerfHandlerForBatchIngestion extends CommonProtocolHandlerForIngestion<AssetRecord, TransportPerformanceCounters>
{
    public static class SamplesContextImpl extends SamplesContext<AssetRecord, TransportPerformanceCounters>
    {
        @Override
                                           ...
                                           String contents)
        {
            ...
            try
            {
                if (contents != null)
                {
                    TransportPerformanceCounters obj = TransportPerformanceCounters.deserializeFromJson(contents);

                    NetworkAssetRecord.TypeExtractor    extractor = new NetworkAssetRecord.TypeExtractor();
    ...
    public NetworkPerfHandlerForBatchIngestion(HubConfiguration cfg,
                                               Logger logger,
                                               StagedResultsSummary.ForAsset forAsset)
    {
    ...
    {
        return context.rootSummary.registerAsset(context.summaryForDatabase, NetworkAssetRecord.class, m_forAsset.identifier, true);
    }
    ...
    {
        // We place all the objects under the Network record.
    ...
    @Override
    protected SamplesContext<AssetRecord, TransportPerformanceCounters> prepareSampleUpdateContext()
    {
