...
@Optio3TableInfo(externalId = "HostAssetLog", model = BaseModel.class, metamodel = HostAssetLogRecord_.class, defragmentOnBoot = true)
public class HostAssetLogRecord extends CommonLogRecord
{
    /**
    ...
    private HostAssetRecord owningHost;

    public static HostAssetLogRecord newInstance(HostAssetRecord rec_host)
    {
        HostAssetLogRecord rec_log = new HostAssetLogRecord();
    ...
    public HostAssetRecord getOwningHost()
    {
        return owningHost;
    }
}
