...
@JsonTypeName("MetricsEngineOperatorVectorBinaryAdd")
public class MetricsEngineOperatorVectorBinaryAdd extends MetricsEngineOperatorVectorBinary<MetricsEngineValueSetOfSeries, MetricsEngineValueSetOfSeries, MetricsEngineValueSetOfSeries>
{
    public MetricsEngineOperatorVectorBinaryAdd()
    {
