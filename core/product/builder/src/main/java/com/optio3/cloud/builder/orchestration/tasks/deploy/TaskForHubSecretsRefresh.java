...
public class TaskForHubSecretsRefresh extends BaseDeployTask
{
                                                                          ...
                                                                          Exception
    {
        ...
        return BaseDeployTask.scheduleActivity(lock_targetHost, targetService, DeploymentRole.hub, null, TaskForHubSecretsRefresh.class, (t) ->
        {
    ...
    {
        return String.format("Refresh shared secrets on host '%s'", getHostDisplayName());
    }
