...
public class TaskForBootOptionsPush extends BaseTaskForAgent
{
                                                                                            ...
                                                                                            Exception
    {
        ...
        return BaseDeployTask.scheduleActivity(lock_targetHost, null, TaskForBootOptionsPush.class, (t) ->
        {
            t.optValue = optValue;
        });
    }
    ...
    {
        return String.format("Push boot option to host '%s'", getHostDisplayName());
    }
                                             ...
                                             Exception
    {
        ...
        await(proxy.setBootParameter(optValue.key != null ? optValue.key.encoding : optValue.keyRaw, optValue.value));
