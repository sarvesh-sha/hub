...
public class BuilderBackgroundActivityTest extends Optio3Test
{
    ...
    public static class TestActivity extends AbstractBuilderActivityHandler implements BackgroundActivityHandler.ICleanupOnFailure
    {
        public int     state;
