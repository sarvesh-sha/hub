...
{
    @ClassRule
    public static final TestApplicationRule<ProvisionerApplication, ProvisionerConfiguration> applicationRule = new ProvisionerTestApplicationRule((configuration) ->
                                                                                                                                                   {
                                                                                                                                                   }, (application) ->
                                                                                                                                                   {
                                                                                                                                                   });
