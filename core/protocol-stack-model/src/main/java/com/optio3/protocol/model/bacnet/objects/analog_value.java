...
@JsonTypeName("BACnet:analog_value")
public final class analog_value extends BACnetObjectModel
{
    // @formatter:off
    ...
    public float                               fault_high_limit;
    public float                               fault_low_limit;
    ...
    public float                               max_pres_value;
    public float                               min_pres_value;
    ...
    public analog_value()
    {
        super(BACnetObjectType.analog_value);
