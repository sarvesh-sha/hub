...
@JsonTypeName("Ipn:Obdii:ISO15765:IntakeAirTemperature")
@Iso15765MessageType(service = 1, pdu = 15)
public class IntakeAirTemperature extends BaseIso15765ObjectModel
{
    ...
    {
        return "ISO15765_IntakeAirTemperature";
    }
}
