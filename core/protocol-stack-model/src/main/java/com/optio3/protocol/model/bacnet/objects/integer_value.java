...
@JsonTypeName("BACnet:integer_value")
public final class integer_value extends BACnetObjectModel
{
    // @formatter:off
    ...
    {
        super(BACnetObjectType.integer_value);
