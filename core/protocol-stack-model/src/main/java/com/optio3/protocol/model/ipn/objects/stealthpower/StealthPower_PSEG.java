...
@JsonTypeName("Ipn:StealthPower::PSEG")
public class StealthPower_PSEG extends BaseStealthPowerModel
{
    // @formatter:off
    ...
    public StealthPowerSystemStateForPSEG system_state;
    ...
    @FieldModelDescription(description = "Charge Enable", units = EngineeringUnits.onOff, pointClass = WellKnownPointClass.NoIdleChargeEnable, debounceSeconds = 15)
    public boolean charge_enable;

    @FieldModelDescription(description = "Discharge Enable", units = EngineeringUnits.onOff, pointClass = WellKnownPointClass.NoIdleDischargeEnable, debounceSeconds = 15)
    public boolean discharge_enable;
