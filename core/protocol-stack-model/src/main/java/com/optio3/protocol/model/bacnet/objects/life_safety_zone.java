...
@JsonTypeName("BACnet:life_safety_zone")
public final class life_safety_zone extends BACnetObjectModel
{
    // @formatter:off
    ...
    public List<BACnetDeviceObjectReference>   zone_members;
    ...
    public boolean                             maintenance_required;
    ...
    public life_safety_zone()
    {
        super(BACnetObjectType.life_safety_zone);
        ...
        zone_members = Lists.newArrayList();
    }
}
