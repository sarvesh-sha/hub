...
@JsonTypeName("BACnet:trend_log")
public final class trend_log extends BACnetObjectModel
{
    // @formatter:off
    ...
    public List<BACnetLogRecord>               log_buffer;
    ...
    public trend_log()
    {
        super(BACnetObjectType.trend_log);
