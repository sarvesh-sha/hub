...
@JsonTypeName("BACnet:datetimepattern_value")
public final class datetimepattern_value extends BACnetObjectModel
{
    // @formatter:off
    ...
    public BACnetDateTime                      present_value;
    ...
    public BACnetDateTime                      relinquish_default;
    public BACnetNameValue[]                   tags;
    public BACnetValueSource                   value_source;
    public BACnetValueSource[]                 value_source_array;
    // @formatter:on

    public datetimepattern_value()
    {
        super(BACnetObjectType.datetimepattern_value);
