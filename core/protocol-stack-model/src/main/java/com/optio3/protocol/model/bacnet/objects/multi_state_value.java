...
@JsonTypeName("BACnet:multi_state_value")
public final class multi_state_value extends BACnetObjectModel
{
    // @formatter:off
    ...
    public multi_state_value()
    {
        super(BACnetObjectType.multi_state_value);
