...
@JsonTypeName("BACnet:channel")
public final class channel extends BACnetObjectModel
{
    // @formatter:off
    ...
    public long[]                                control_groups;
    public BACnetDeviceObjectPropertyReference[] list_of_object_property_references;
    public BACnetChannelValue                    present_value;
    ...
    public boolean                               allow_group_delay_inhibit;
    ...
    public channel()
    {
        super(BACnetObjectType.channel);
