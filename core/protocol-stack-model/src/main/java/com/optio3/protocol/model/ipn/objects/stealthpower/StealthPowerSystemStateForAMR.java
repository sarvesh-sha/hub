...
public enum StealthPowerSystemStateForAMR implements TypedBitSet.ValueGetter
{
    // @formatter:off
    ...
    StealthPowerSystemStateForAMR(int encoding)
    {
        m_encoding = (byte) encoding;
    }

    @HandlerForDecoding
    public static StealthPowerSystemStateForAMR parse(byte value)
    {
        for (StealthPowerSystemStateForAMR t : values())
        {
