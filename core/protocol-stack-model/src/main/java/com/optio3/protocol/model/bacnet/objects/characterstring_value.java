...
@JsonTypeName("BACnet:characterstring_value")
public final class characterstring_value extends BACnetObjectModel
{
    // @formatter:off
    ...
    public Optional<String[]>                  alarm_values;
    ...
    public Optional<String[]>                  fault_values;
    ...
    public String                              relinquish_default;
    ...
    public characterstring_value()
    {
        super(BACnetObjectType.characterstring_value);
