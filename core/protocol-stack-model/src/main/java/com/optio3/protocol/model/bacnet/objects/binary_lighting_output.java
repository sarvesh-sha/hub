...
@JsonTypeName("BACnet:binary_lighting_output")
public final class binary_lighting_output extends BACnetObjectModel
{
    // @formatter:off
    ...
    public BACnetBinaryLightingPV              relinquish_default;
    ...
    //
    public BACnetBinaryLightingPV              present_value;
    ...
    public BACnetBinaryLightingPV              feedback_value;
