...
@JsonTypeName("BACnet:datepattern_value")
public final class datepattern_value extends BACnetObjectModel
{
    // @formatter:off
    ...
    public BACnetDate                          present_value;
