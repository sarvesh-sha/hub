...
@JsonTypeName("BACnet:analog_output")
public final class analog_output extends BACnetObjectModel
{
    // @formatter:off
    ...
    public Optional<Float>                     interface_value;
    ...
    {
        super(BACnetObjectType.analog_output);
