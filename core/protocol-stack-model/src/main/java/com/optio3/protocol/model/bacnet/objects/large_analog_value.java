...
@JsonTypeName("BACnet:large_analog_value")
public final class large_analog_value extends BACnetObjectModel
{
    // @formatter:off
    ...
    public double                              fault_high_limit;
    public double                              fault_low_limit;
    ...
    public double                              max_pres_value;
    public double                              min_pres_value;
    ...
    public double                              relinquish_default;
    ...
    public large_analog_value()
    {
        super(BACnetObjectType.large_analog_value);
