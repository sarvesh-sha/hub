...
import com.optio3.protocol.model.bacnet.enums.BACnetLoggingType;
...
@JsonTypeName("BACnet:trend_log_multiple")
public final class trend_log_multiple extends BACnetObjectModel
{
    // @formatter:off
    ...
    public List<BACnetLogMultipleRecord>         log_buffer;
    public BACnetDeviceObjectPropertyReference[] log_device_object_property;
    public long                                  log_interval;
    public BACnetLoggingType                     logging_type;
    ...
    public trend_log_multiple()
    {
        super(BACnetObjectType.trend_log_multiple);
