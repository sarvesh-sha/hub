...
@JsonTypeName("Ipn:StealthPower::MTA")
public class StealthPower_MTA extends BaseStealthPowerModel
{
    // @formatter:off
    ...
    public StealthPowerSystemStateForMTA system_state;
    ...
    // Legacy field, don't remove.
    public float fuel_pump;
