...
@JsonTypeName("Ipn:Obdii:ISO15765:ThrottlePosition")
@Iso15765MessageType(service = 1, pdu = 17)
public class ThrottlePosition extends BaseIso15765ObjectModel
{
    ...
    {
        return "ISO15765_ThrottlePosition";
    }
}
