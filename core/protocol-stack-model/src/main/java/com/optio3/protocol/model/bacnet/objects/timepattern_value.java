...
@JsonTypeName("BACnet:timepattern_value")
public final class timepattern_value extends BACnetObjectModel
{
    // @formatter:off
    ...
    public BACnetTime                          present_value;
