...
{
  public static final String RECORD_IDENTITY = "JobDefinitionStepForMaven";


  public String pullFrom = null;
  ...
  public String toString()
  {
    ...
    sb.append("class JobDefinitionStepForMaven {\n");
    sb.append("    ").append(super.toString().replace("\n", "\n    ")).append("\n");
    sb.append("    pullFrom: ").append(toIndentedString(pullFrom)).append("\n");
