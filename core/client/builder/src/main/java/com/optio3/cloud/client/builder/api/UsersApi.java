...
import com.optio3.cloud.client.builder.model.DetailedApplicationExceptionErrorDetails;
import com.optio3.cloud.client.builder.model.User;
...
public interface UsersApi
{
    ...
    public User resetPassword(@FormParam(value = "token") String token, @FormParam(value = "newPassword") String newPassword);
