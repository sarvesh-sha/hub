...
@JsonTypeName("MbControlListChannelsReply")
public class MbControlListChannelsReply extends MbControlReply
{

  public List<String> availableChannels = new ArrayList<String>();

  @Override
  public String toString()
  {
    StringBuilder sb = new StringBuilder();
    sb.append("class MbControlListChannelsReply {\n");
