...
{
  public static final String RECORD_IDENTITY = "DockerVolume";
  ...
  public List<RecordIdentity> mappedAs = new ArrayList<RecordIdentity>();

  @Override
  public String toString()
  {
    StringBuilder sb = new StringBuilder();
    sb.append("class DockerVolume {\n");
    ...
    sb.append("    mappedAs: ").append(toIndentedString(mappedAs)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  /**
