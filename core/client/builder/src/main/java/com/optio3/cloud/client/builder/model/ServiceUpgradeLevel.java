...
public class ServiceUpgradeLevel
{
  ...
  public List<String> fixupProcessors = new ArrayList<String>();

  @Override
  public String toString()
  {
    StringBuilder sb = new StringBuilder();
    sb.append("class ServiceUpgradeLevel {\n");

    sb.append("    service: ").append(toIndentedString(service)).append("\n");
    sb.append("    fixupProcessors: ").append(toIndentedString(fixupProcessors)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  /**
