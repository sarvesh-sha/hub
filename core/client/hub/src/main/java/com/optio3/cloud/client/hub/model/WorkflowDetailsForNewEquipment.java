...
public class WorkflowDetailsForNewEquipment extends WorkflowDetails
{
  ...
  public String toString()
  {
    ...
    sb.append("class WorkflowDetailsForNewEquipment {\n");
    sb.append("    ").append(super.toString().replace("\n", "\n    ")).append("\n");
    sb.append("    equipmentKey: ").append(toIndentedString(equipmentKey)).append("\n");
