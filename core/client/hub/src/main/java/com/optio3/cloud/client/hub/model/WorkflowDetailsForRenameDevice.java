...
public class WorkflowDetailsForRenameDevice extends WorkflowDetails
{

  public List<WorkflowAsset> devices = new ArrayList<WorkflowAsset>();
  public String deviceNewName = null;

  @Override
  public String toString()
  {
    StringBuilder sb = new StringBuilder();
    sb.append("class WorkflowDetailsForRenameDevice {\n");
    sb.append("    ").append(super.toString().replace("\n", "\n    ")).append("\n");
    sb.append("    devices: ").append(toIndentedString(devices)).append("\n");
    sb.append("    deviceNewName: ").append(toIndentedString(deviceNewName)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  /**
