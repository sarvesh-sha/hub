...
public class TimeSeriesMultiPropertyRequest
{
  ...
  public List<TimeSeriesPropertyRequest> specs = new ArrayList<TimeSeriesPropertyRequest>();
  ...
  public String toString()
  {
    ...
    sb.append("class TimeSeriesMultiPropertyRequest {\n");
