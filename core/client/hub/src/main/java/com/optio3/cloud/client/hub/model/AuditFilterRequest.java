...
public class AuditFilterRequest extends EventFilterRequest
{
  ...
  public List<AuditType> auditTypeIDs = new ArrayList<AuditType>();

  @Override
  public String toString()
  {
    StringBuilder sb = new StringBuilder();
    sb.append("class AuditFilterRequest {\n");
    sb.append("    ").append(super.toString().replace("\n", "\n    ")).append("\n");
    sb.append("    auditTypeIDs: ").append(toIndentedString(auditTypeIDs)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  /**
