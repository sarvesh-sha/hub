...
public class AlertEngineValueDeliveryOptions extends EngineValue
{
  ...
  public List<String> resolvedUsers = new ArrayList<String>();

  @Override
  public String toString()
  {
    StringBuilder sb = new StringBuilder();
    sb.append("class AlertEngineValueDeliveryOptions {\n");
    sb.append("    ").append(super.toString().replace("\n", "\n    ")).append("\n");
    sb.append("    resolvedUsers: ").append(toIndentedString(resolvedUsers)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  /**
