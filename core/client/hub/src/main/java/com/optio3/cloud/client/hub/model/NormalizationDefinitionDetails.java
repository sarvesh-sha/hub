...
@JsonSubTypes(
{
    @JsonSubTypes.Type(value = NormalizationDefinitionDetailsForUserProgram.class)
})
public class NormalizationDefinitionDetails
{
  ...
  public String toString()
  {
    ...
    sb.append("class NormalizationDefinitionDetails {\n");
