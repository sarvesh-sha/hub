...
public enum DayOfWeek
{
    ...
    public static DayOfWeek fromValue(String v)
    {
        ...
        throw new IllegalArgumentException(String.format("'%s' is not one of the values accepted for %s class: %s", v, DayOfWeek.class.getSimpleName(), Arrays.toString(DayOfWeek.values())));
    }
}
