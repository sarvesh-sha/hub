...
public class AlertWidgetConfiguration extends WidgetConfiguration
{


  public List<AlertType> alertTypes = new ArrayList<AlertType>();

  @Override
  public String toString()
  {
    StringBuilder sb = new StringBuilder();
    sb.append("class AlertWidgetConfiguration {\n");
