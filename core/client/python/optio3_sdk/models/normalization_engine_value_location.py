...
class NormalizationEngineValueLocation(object):
    """
    NOTE: This class is auto generated by the swagger code generator program.
    Do not edit the class manually.
    """
    def __init__(self, name=None, type=None):
        """
        NormalizationEngineValueLocation - a model defined in Swagger
    ...
    def discriminator___type(self):
        return "NormalizationEngineValueLocation"
    ...
    def name(self):
        """
        Gets the name of this NormalizationEngineValueLocation.

        :return: The name of this NormalizationEngineValueLocation.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        """
        Sets the name of this NormalizationEngineValueLocation.

        :param name: The name of this NormalizationEngineValueLocation.
        :type: str
        """
    ...
    def type(self):
        """
        Gets the type of this NormalizationEngineValueLocation.

        :return: The type of this NormalizationEngineValueLocation.
        :rtype: str
        """
        return self._type
    ...
    def type(self, type):
        """
        Sets the type of this NormalizationEngineValueLocation.

        :param type: The type of this NormalizationEngineValueLocation.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, NormalizationEngineValueLocation):
            return False
