...
@JsonTypeName("ProberOperationForBACnetToScanSubnetForDevices")
public class ProberOperationForBACnetToScanSubnetForDevices extends ProberOperationForBACnet
{
    @JsonTypeName("ProberOperationForBACnetToScanSubnetForDevicesResults") // No underscore in model name, due to Swagger issues.
