...
import com.optio3.cloud.client.waypoint.model.SensorResultForI2CHubScan;
...
public class SensorResultForI2CHub extends SensorResult
{
  ...
  public List<SensorResultForI2CHubScan> busScan = new ArrayList<SensorResultForI2CHubScan>();

  @Override
  public String toString()
  {
    StringBuilder sb = new StringBuilder();
    sb.append("class SensorResultForI2CHub {\n");
    sb.append("    ").append(super.toString().replace("\n", "\n    ")).append("\n");
    sb.append("    present: ").append(toIndentedString(present)).append("\n");
    sb.append("    busScan: ").append(toIndentedString(busScan)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  /**
