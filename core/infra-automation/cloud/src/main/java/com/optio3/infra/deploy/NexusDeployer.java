...
public class NexusDeployer extends CommonDeployerForAWS
{
    public String roleName       = "Nexus-Instance";
    public String instanceConfig = "nexus";

    public String computeInstanceName        = "nexus";
    public String computeInstanceDisplayName = "Nexus service";

    public String vpcName        = "vpc--nexus";
    public String vpcDisplayName = "Nexus service";

    public String hostName   = "repo.dev";
    public String domainName = WellKnownSites.optio3DomainName();

    //--//

    public NexusDeployer(CredentialDirectory credDir)
    {
                                             ...
                                             IOException
    {
        try (AwsHelper aws = fetchAwsHelper(null))
        {
            ...
            SecurityGroup sc = aws.acquireSecurityGroup(vpc, securityGroupName, vpcAnnotatedName, (scNew) ->
            {
                ...
                aws.authorizeIngress(scNew, "tcp", 5000, 5002, "0.0.0.0/0");
            });
            ...
            cfg.instanceType = InstanceType.T2Medium.toString();

            cfg.profile = profile;
            aws.useGenericBootScript(cfg, instanceConfig, "", "");
