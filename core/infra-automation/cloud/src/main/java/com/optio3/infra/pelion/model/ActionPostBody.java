...
public class ActionPostBody
{
    ...
    /**
     * The physical ID of the new target subscriber.
     */
    public String newPhysicalId = null;

    @Override
    public String toString()
    {
        StringBuilder sb = new StringBuilder();
        sb.append("class ActionPostBody {\n");

        sb.append("    newPhysicalId: ")
          .append(toIndentedString(newPhysicalId))
          .append("\n");
        sb.append("}");
        return sb.toString();
    }
