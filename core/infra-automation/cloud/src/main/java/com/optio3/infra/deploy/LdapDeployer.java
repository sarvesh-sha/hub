...
public class LdapDeployer extends CommonDeployerForAWS
{
    public String roleName       = "OpenLdap-Instance";
    public String instanceConfig = "openldap";

    public String computeInstanceName        = "openldap";
    public String computeInstanceDisplayName = "OpenLDAP service";

    public String vpcName        = "vpc--openldap";
    public String vpcDisplayName = "OpenLDAP service";

    public String hostName   = "ldap.dev";
    public String domainName = WellKnownSites.optio3DomainName();

    //--//

    public LdapDeployer(CredentialDirectory credDir)
    {
                                             ...
                                             IOException
    {
        try (AwsHelper aws = fetchAwsHelper(null))
        {
            ...
            SecurityGroup sc = aws.acquireSecurityGroup(vpc, securityGroupName, vpcAnnotatedName, (scNew) ->
            {
                ...
                // LDAP port.
                aws.authorizeIngress(scNew, "tcp", 636, "0.0.0.0/0");
            });
