...
public class ActivationResponse
{
    ...
    /**
     * <p>The unique <em>physical</em> subscriber identifier&#58;</p><ul><li><em>Cellular</em> - the ICCID</li><li><em>Non-IP</em> - the  EUI</li><li><em>Satellite</em> - the IMEI</li></ul>
     */
    public String physicalId   = null;
    /**
     * <p>The unique <em>network</em> subscriber identifier&#58;</p><ul><li>Cellular subscriber - the MSISDN</li><li>Non-IP subscriber - the Device EUI</li><li>Satellite subscriber - the Subscription ID</li></ul>
     */
    ...
    public String toString()
    {
        ...
        sb.append("    dataNumber: ")
          .append(toIndentedString(dataNumber))
          .append("\n");
        sb.append("    imsi: ")
        ...
        sb.append("    physicalId: ")
          .append(toIndentedString(physicalId))
          .append("\n");
        sb.append("    subscriberId: ")
          .append(toIndentedString(subscriberId))
          .append("\n");
        sb.append("}");
        return sb.toString();
    }
