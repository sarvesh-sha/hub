...
public class SubscriberActionsResponse
{

    /**
     * Returns a list of actions that you can perform for the specified subscriber.
     */
    public List<SubscriberAction> content = new ArrayList<SubscriberAction>();

    @Override
    public String toString()
    {
        StringBuilder sb = new StringBuilder();
        sb.append("class SubscriberActionsResponse {\n");
