...
public class ImagesPruneReport
{
     ...
     */
    public List<ImageDeleteResponseItem> imagesDeleted  = new ArrayList<ImageDeleteResponseItem>();
    /**
    ...
    public String toString()
    {
        ...
        sb.append("class ImagesPruneReport {\n");

        sb.append("    imagesDeleted: ")
          .append(toIndentedString(imagesDeleted))
          .append("\n");
